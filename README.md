...
## Insurance Domain Schema Example

This section documents a complete insurance domain schema with customers, products, subscriptions, payments, and claims.
...
### Using SQL Names vs System Names

IBM i DB2 truncates long SQL names to 10-character system names. QADMCLI now **auto-resolves** SQL names:
